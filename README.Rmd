...
explained in Park, J. (2025). These methods are built on a _simulation meta model_ which assumes that
...
#### References
Park, J. (2025). Scalable simulation-based inference for implicitly defined models using a metamodel for log-likelihood estimator <https://doi.org/10.48550/arxiv.2311.09446>
